%Cross Correlation (Same factory: fixed F)
...
for k = 1:5
    ...
    for j = 1:4096
        ...
        for i = 1:2
            ...
            if i == 1
                fixedF = randomF;
                ppn1(j,:) = lambdaF*fixedF + lambdaL*randomL + lambdaM*randomM + lambdaO*randomO + lambdaA*randomA;
            else
                ppn2(j,:) = lambdaF*fixedF + lambdaL*randomL + lambdaM*randomM + lambdaO*randomO + lambdaA*randomA;
            end
        end
    end
...
xlabel('Index')
ylabel('Correlation')
title('Self Correlation Gaussian Same Factory')
