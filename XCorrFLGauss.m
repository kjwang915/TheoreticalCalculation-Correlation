%Cross Correlation (Same factory, same layout: fixed F,L)
    ...
    for j = 1:4096
        ...
        for i = 1:2
            ...
            if i == 1
                fixedF = randomF;
                fixedL = randomL;
                ppn1(j,:) = lambdaF*fixedF + lambdaL*fixedL + lambdaM*randomM + lambdaO*randomO + lambdaA*randomA;
            else
                ppn2(j,:) = lambdaF*fixedF + lambdaL*fixedL + lambdaM*randomM + lambdaO*randomO + lambdaA*randomA;
            end
        end
    end
...
xlabel('Index')
ylabel('Correlation')
title('Self Correlation Gaussian Same Factory Same Layout')



%selfCorr = abs(corr(ppn1,ppn2))
